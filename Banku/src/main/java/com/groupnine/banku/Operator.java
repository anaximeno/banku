...
public class Operator {
    ...
    public boolean makeTransaction(Account from, Account to, double value, String details) {
        final double enterpriseAccountTransactionInterestRate = 0.2;
        ...
        if (from instanceof EnterpriseAccount eac) {
            double transactionInterest = enterpriseAccountTransactionInterestRate * value;
        ...
        Transaction transaction = new Transaction(
                this, LocalDateTime.now(), from, to, value, accountFromBalance, accountToBalance, details);
